...
if (isset($_GET['id'])) {
    ...
    if (!$contact) {
        message('Error: Contact does not exist with that ID.', 'contacts.php', true);
    }
    ...
    if (isset($_GET['confirm'])) {
        if($_GET['confirm'] == 'yes') {
            ...
            $stmt->execute([$_GET['id']]);
            // Output msg
            message('Contact deleted successfully.', 'contacts.php', false);
        } else {
...
<div class = "columns">
    ...
    <div class = "column" >
        ...
        <h2 class="subtitle">Are you sure you want to delete contact : <?=$contact['name']?></h2>
